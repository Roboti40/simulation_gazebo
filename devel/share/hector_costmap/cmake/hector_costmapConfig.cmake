...
if("TRUE" STREQUAL "TRUE")
  set(hector_costmap_SOURCE_PREFIX /home/laborobotique/catkin_ws/src/hector_navigation-noetic-devel/hector_costmap)
  set(hector_costmap_DEVEL_PREFIX /home/laborobotique/catkin_ws/devel)
  ...
  set(hector_costmap_INSTALL_PREFIX /home/laborobotique/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'hector_costmap' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'hector_costmap' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/laborobotique/catkin_ws/src/hector_navigation-noetic-devel/hector_costmap/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT hector_costmap_NUM_DUMMY_TARGETS)
      set(hector_costmap_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::hector_costmap::wrapped-linker-option${hector_costmap_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR hector_costmap_NUM_DUMMY_TARGETS "${hector_costmap_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::hector_costmap::wrapped-linker-option${hector_costmap_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND hector_costmap_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${hector_costmap_dep}_FOUND)
      find_package(${hector_costmap_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${hector_costmap_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  ...
  _list_append_deduplicate(hector_costmap_EXPORTED_TARGETS ${${hector_costmap_dep}_EXPORTED_TARGETS})
endforeach()

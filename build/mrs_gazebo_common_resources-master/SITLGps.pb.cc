...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::sensor_msgs::msgs::SITLGps, time_),
...
static const ::google::protobuf::internal::MigrationSchema schemas[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 15, sizeof(::sensor_msgs::msgs::SITLGps)},
};
...
// @@protoc_insertion_point(message_clear_start:sensor_msgs.msgs.SITLGps)
  ...
  if (cached_has_bits & 255u) {
    ::memset(&time_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&velocity_east_) -
        reinterpret_cast<char*>(&time_)) + sizeof(velocity_east_));
  }
  if (cached_has_bits & 768u) {
    ::memset(&velocity_north_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&velocity_up_) -
        reinterpret_cast<char*>(&velocity_north_)) + sizeof(velocity_up_));
  }
  _has_bits_.Clear();

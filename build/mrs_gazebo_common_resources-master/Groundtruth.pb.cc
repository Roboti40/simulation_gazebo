...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::sensor_msgs::msgs::Groundtruth, time_),
...
Groundtruth::Groundtruth(const Groundtruth& from)
  ...
  ::memcpy(&time_, &from.time_,
    ...
    reinterpret_cast<char*>(&time_)) + sizeof(attitude_q_z_));
...
// @@protoc_insertion_point(message_clear_start:sensor_msgs.msgs.Groundtruth)
  ...
  if (cached_has_bits & 255u) {
    ::memset(&time_, 0, static_cast<size_t>(
        ...
        reinterpret_cast<char*>(&time_)) + sizeof(attitude_q_w_));
  }
